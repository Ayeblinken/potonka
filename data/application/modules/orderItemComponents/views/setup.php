                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="records" >
                                <thead>
                                    <tr>
                                        <th>BuildItem</th>
                                        <th>Category</th>
                                        <th style="width:500px">Direction</th>
                                        <th>Inventory</th>
                                        <th></th>
                                        <th class="hide"></th> 
                                        <th class="hide"></th> 
                                ...
                                <div id="descriptionShow" class="row-fluid">
                                    <div class="span12">
                                        <div class="control-group test78">
                                            ...
                                            <div class="controls">
                                                <div class="btn-group">
                                                <button id="DescriptionNameLabel" class="btn dropdown-toggle" data-toggle="dropdown">Direction<span class="caret"></span></button>
                                                ...
                                                <!--</div>-->
                                                <textarea name="modalDescription" id="modalDescription" rows="3"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>

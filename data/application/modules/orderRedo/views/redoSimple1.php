...
<!--                <div class="row-fluid">
                ...
                <div class="row-fluid">
                     <a target="_blank" id="redoRequestPage" href="redorequest/<?php echo $orderID?>" class="btn"><i class="icon-plus"></i> Redo Request</a>
                     <br> &nbsp;
                </div>
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <script type="text/template" id="readTemplate">
                            <tr id="${OrderRedoID}">
                                <td><a class="statusBtn" target="_blank"  href="redo/${OrderRedoID}/">${Status}</a></td>
                                <td>${ItemsRedo}</td>
                                <td><a class="orderIDBtn" href="orders/<?php echo $orderID; ?>">${kf_OrderIDRedo}</a></td>
                                <td>${Department}</td>
                                <td>${CustomerIssue}</td>
                                <td>${Problem}</td>
                                <td>${solution}</td>

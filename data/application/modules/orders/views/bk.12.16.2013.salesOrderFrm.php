...
<!--            <button id="btnWizardNext" class="btn btn-xs btn-next" data-last="Finish">Next<i class="glyphicon glyphicon-arrow-right"></i></button>-->
    ...
    <div class="step-content">
        <div class="step-pane active" id="step1">
            ...
            {?>
                 <iframe name="orderRequestView" id="orderRequestView" src=<?php echo 'https://apps.indyimaging.com/apps/orderRequest/'.$orderID ?> seamless width=100% height="1200"></iframe>
               
           <?php 
            }
            else 
            {?>
                <iframe name="orderRequestView" id="orderRequestView" src="https://apps.indyimaging.com/apps/orderRequest/" seamless width=100% height="1200"></iframe>
            <?php
            }
            ?>
   ...
   $('#MyWizard').on('change', function(e, data) {
      ...
      if(data.step===1 && data.direction==='next') 
      {
           ...
           else
           {
                ...
                iframe.attr("src",'https://apps.indyimaging.com/apps/customerTerm/'+$("#iframeCustomerID").val()+'#sales');
...
//                });
      ...
      if(data.step===2 && data.direction==='next') 
      {
            ...
            iframeTemplateListView.attr("src",'https://apps.indyimaging.com/apps/orderNotes/'+$("#iframeOrderID").val()+'/customerOrderView');
            //alert("step2.2");
      ...
      if(data.step===3 && data.direction==='next') 
      {
            ...
            iframeTemplateListView.attr("src",'https://apps.indyimaging.com/apps/orderContacts/'+$("#iframeOrderID").val());
            //alert("step2.2");
      ...
      if(data.step===4 && data.direction==='next') 
      {
            ...
            iframeTemplateListView.attr("src",'https://apps.indyimaging.com/apps/loadTemplateList/'+$("#iframeOrderID").val());
            //alert("step2.2");
      ...
      if(data.step===5 && data.direction==='next') 
      {
            ...
            //alert("step2.1"+$("#iframeOrderID").val());
            iframeTemplateListView.attr("src",'https://apps.indyimaging.com/apps/otherCharges/'+$("#iframeOrderID").val());
            //alert("step2.2");
      ...
      if(data.step===6 && data.direction==='next') 
      {
            ...
            //alert("step2.1"+$("#iframeOrderID").val());
            iframeTemplateListView.attr("src",'https://apps.indyimaging.com/apps/orderShip/'+$("#iframeOrderID").val());
            //alert("step2.2");

                                                            ...
                                                            <tr>
                                                                ...
                                                                <td> 
                                                                    <?php if(!is_null($row->t_OrderItemImage)): ?>
                                                                        <img src=<?php date_default_timezone_set('America/Indianapolis'); echo '//apps.indyimaging.com/images/Orders/'.date('Y',strtotime($row->d_Received)).'/'.date('m',strtotime($row->d_Received)).'/'.$row->kf_OrderID.'/'.$row->kp_OrderItemID.'/'.rawurlencode($row->t_OrderItemImage); ?> height="150" width="150">
                                                                    <?php endif; ?>
                                                                </td>
                                                            </tr>
                                                            <?php endforeach;?> 

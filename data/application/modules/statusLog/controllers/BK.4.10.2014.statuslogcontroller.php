...
//            }
    ...
    public function customOrderItemStatusChange($orderItemID=null,$newStatus=null,$userName=null)
    {
        ...
        if($orderItemJobStatus && $newStatus && $userName)
        {
            $oldStatus          = $orderItemJobStatus->orderItemJobStatus;
            $orderID            = $orderItemJobStatus->kf_OrderID;
            $orderItemID        = $orderItemJobStatus->kp_OrderItemID;
            
            $userName           = urldecode($userName);
            $newStatus          = urldecode($newStatus);
            ...
            if($orderArry['t_JobStatus'] == "Multi Line Status")
            {
                ...
                $updateOrderItemJobStatus = Modules::run('orderItems/orderitemcontroller/updateOrderItemJobStatus',$newStatus,$orderItemID);
                ...
                $data[0] = array(
                    ...
                    't_StatusNew'=> $newStatus,
                    't_ApprovedByName'=> $userName,
        ...
        {
            echo "No_OrderItemIDFoundInTheSystem";
        } 
    ...
    public function customOrderStatusChange($orderID=null,$newStatus=null,$userName=null)
    {
        ...
        if(isset($orderID) && isset($newStatus) && isset($userName))
        {
            ...
            //echo $newStatus."<br/>";
            //echo $userName."<br/>";
            $updateOrderTable = Modules::run('orders/ordercontroller/updateOrderJobStatus',$newStatus,$orderID);
